...
create policy "Project Hub users read own projects"
on public.project_hub_projects for select
to authenticated
using ((select auth.uid()) = user_id);

drop policy if exists "Project Hub users insert own projects" on public.project_hub_projects;
create policy "Project Hub users insert own projects"
on public.project_hub_projects for insert
to authenticated
with check ((select auth.uid()) = user_id);

drop policy if exists "Project Hub users update own projects" on public.project_hub_projects;
create policy "Project Hub users update own projects"
on public.project_hub_projects for update
to authenticated
using ((select auth.uid()) = user_id)
with check ((select auth.uid()) = user_id);

drop policy if exists "Project Hub users delete own projects" on public.project_hub_projects;
create policy "Project Hub users delete own projects"
on public.project_hub_projects for delete
to authenticated
using ((select auth.uid()) = user_id);

drop policy if exists "Project Hub users read own tasks" on public.project_hub_tasks;
create policy "Project Hub users read own tasks"
on public.project_hub_tasks for select
to authenticated
using ((select auth.uid()) = user_id);

drop policy if exists "Project Hub users insert own tasks" on public.project_hub_tasks;
create policy "Project Hub users insert own tasks"
on public.project_hub_tasks for insert
to authenticated
with check ((select auth.uid()) = user_id);

drop policy if exists "Project Hub users update own tasks" on public.project_hub_tasks;
create policy "Project Hub users update own tasks"
on public.project_hub_tasks for update
to authenticated
using ((select auth.uid()) = user_id)
with check ((select auth.uid()) = user_id);

drop policy if exists "Project Hub users delete own tasks" on public.project_hub_tasks;
create policy "Project Hub users delete own tasks"
on public.project_hub_tasks for delete
to authenticated
using ((select auth.uid()) = user_id);

create index if not exists project_hub_projects_user_updated_idx
  on public.project_hub_projects (user_id, updated_at desc);

create index if not exists project_hub_projects_user_source_idx
  on public.project_hub_projects (user_id, source);

create index if not exists project_hub_tasks_user_done_idx
  on public.project_hub_tasks (user_id, done, created_at desc);
